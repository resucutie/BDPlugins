...
function buildPlugin([BasePlugin, PluginApi]) {
	...
	(() => {
		...
		const {
			PRETTY_KEYS
		} = external_PluginApi_namespaceObject.WebpackModules.find((m => "KeyboardShortcut" === m.default?.displayName));
		class Fuses extends(external_BasePlugin_default()) {
			onStart() {
				(0, modal_namespaceObject.openModal)((props => external_BdApi_React_default().createElement(modal_namespaceObject.ModalRoot, _extends({}, props, {
					...
					separator: false
				}, external_BdApi_React_default().createElement("h2", {
					className: "wrapper-1sSZUt fontDisplay-1dagSA base-1x0h_U size20-17Iy80"
				}, "Plugin renamed")), external_BdApi_React_default().createElement(modal_namespaceObject.ModalContent, null, external_BdApi_React_default().createElement(components_namespaceObject.Text, null, 'The plugin "Fuses" was renamed to "Timezones" and so your version wont recive updates. Please download the renamed plugin to get updates.', external_BdApi_React_default().createElement("br", null), external_BdApi_React_default().createElement("br", null), 'If you don\'t know how, hit the "Open download link" button, press ', external_BdApi_React_default().createElement("div", {
					className: "keybindShortcut-1BD6Z1",
					style: {
						display: "inline-flex",
						margin: 0
					}
				}, external_BdApi_React_default().createElement("span", null, PRETTY_KEYS.mod()), external_BdApi_React_default().createElement("span", {
					style: {
						margin: 0
					}
				}, "s")), " on your keyboard and select your BetterDiscord folder", external_BdApi_React_default().createElement("br", null), external_BdApi_React_default().createElement("br", null))), external_BdApi_React_default().createElement(modal_namespaceObject.ModalFooter, null, external_BdApi_React_default().createElement(components_namespaceObject.Button, {
					onClick: () => {
						window.open("https://raw.githubusercontent.com/abUwUser/BDPlugins/compiled/Timezones/Timezones.plugin.js");
						props.onClose();
					}
				}, "Open download link")))));
			}
